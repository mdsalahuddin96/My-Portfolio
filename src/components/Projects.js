...
const projects = [
  { id: 1, title: "Analytics Dashboard", category: "Full Stack", img: p1, tags: ["React", "Node", "MongoDB"], desc: "Realtime analytics with charts & auth." },
  { id: 2, title: "E-Commerce Platform", category: "Full Stack", img: p2, tags: ["Next.js", "Stripe", "Tailwind"], desc: "Modern shop with cart and checkout." },
  { id: 3, title: "Social App UI", category: "Frontend", img: p3, tags: ["React", "Framer Motion"], desc: "Animated mobile-first social feed." },
  { id: 4, title: "Task Manager", category: "Frontend", img: p4, tags: ["React", "Tailwind"], desc: "Kanban board with drag & drop." },
];
                ...
                <div className="relative aspect-[16/10] overflow-hidden">
                  ...
                  <div className="absolute inset-0 flex items-end justify-start p-5 opacity-0 group-hover:opacity-100 translate-y-4 group-hover:translate-y-0 transition-all duration-500">
                    <div className="flex gap-2">
                      <a href="#" className="px-3 py-1.5 rounded-full bg-gradient-primary text-primary-foreground text-xs font-medium inline-flex items-center gap-1.5">
                        <ExternalLink size={12} /> Live
                      </a>
                      <a href="#" className="px-3 py-1.5 rounded-full bg-gradient-primary text-xs font-medium inline-flex items-center gap-1.5">
